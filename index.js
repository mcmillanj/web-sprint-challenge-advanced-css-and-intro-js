...
function get20s(array)
 {
  const artistBornAndDied = [];
for(let i = 0;i < array.length; i++){
// const twentyCentArray = array[i].years.split("  ");
const twentyCentArray = array[i].years.split(" - ");

// let birthYear = String(twentyCentArray[i]);
let birthYear = Number(twentyCentArray[0]);
//let yearOfDeath = String(twentyCentArray[i]); 
let yearOfDeath = Number(twentyCentArray[0]);
...
function addArtist(array) 
{
  const newObject = { 
    id: 20,
    name: "therman mcmillan", 
    years: "1983 - 2021",
    genre: "Web Design", 
    nationality: "Dominican/african american",
